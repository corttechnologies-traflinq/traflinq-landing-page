              ...
              <form className="mt-8 flex flex-col gap-5" onSubmit={onSubmit}>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="" disabled className="bg-[#0d1018]">
                      {t("placeholders.fleetSize")}
                    </option>
                    {FLEET_SIZE_OPTIONS.map((option) => (
                      <option key={option} value={option} className="bg-[#0d1018]">
                        {option}
                      </option>
                    ))}
                  </select>
                ...
                <Button
                  ...
                  className="mt-2 bg-primary text-white hover:bg-primary/90 h-11 font-bold gap-2"
                >
                  {submitting ? "…" : t("cta")}
